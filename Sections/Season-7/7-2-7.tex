...
If the product of all numbers written on any triangle in the population for which $AB=AC$ can be written in the form $a - b\sqrt{c}$, where $a$, $b$, $c$ are positive integers with $c$ square-free, find $10000a+100b+c$.
}\bigskip
