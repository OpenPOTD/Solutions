...
\SSpsetQ{
  Call a number lonely if each of its digits are unique (that is to say, no two are the same). How many odd integers between \(3\cdot10^4\) and \(8\cdot10^4\) are lonely?\bigskip
